      ...
      <main className="relative z-5 flex-1 px-6 sm:px-12 pt-12 sm:pt-16 pb-16">
        <div className="about-wrap">
          <div className="chip mb-8">
            ...
            <span className="chip-text">{pricing.chip}</span>
          </div>

          <h1 className="about-title">{pricing.title}</h1>
          <p className="type-body about-copy">
            {pricing.body.includes('hello@moxsend.ai') ? (
              <>
                {pricing.body.replace('hello@moxsend.ai', '')}
